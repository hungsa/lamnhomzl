...
class Model_Login extends Database
{
    public function get_username($username)
    {
        ...
        UNION
        SELECT username, name FROM subject_head WHERE username = '$username' OR email = '$username'
        UNION
    ...
    public function get_password($username)
    {
        ...
        UNION
        SELECT permission,password FROM subject_head WHERE username = '$username' OR email = '$username'
        UNION
    ...
    {
        $sql = "SELECT subject_id FROM subject_head WHERE username = '$username'";
        $this->set_query($sql);
        return $this->load_row();
    }
