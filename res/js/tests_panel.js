$(function() {
    ...
    $('.btn-test-normal').on('click', function() {
        create_test_normal();
    })

    $('.btn-test-auto').on('click', function() {
        create_test_auto();
    })
});
...
function test_detail_button(data) {
    return btn = '<a class="waves-effect waves-light btn" style="margin-bottom: 7px;" href="index.php?action=test_detail&test_code=' + data.test_code + '">Chi Tiết</a>';
}
...
function create_test_normal() {
    $('.btn-test-normal').addClass('disable');
    $('.btn-test-auto').removeClass('disable');
    $('.input-field#test-auto').addClass('hidden');
    $('.input-field#test-normal').removeClass('hidden');
} 

function create_test_auto() {
    $('.btn-test-normal').removeClass('disable');
    $('.btn-test-auto').addClass('disable');
    $('.input-field#test-normal').addClass('hidden');
    $('.input-field#test-auto').removeClass('hidden');
} 