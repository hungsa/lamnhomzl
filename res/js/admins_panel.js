...
function submit_add_admin_via_file() {
    ...
    var accepted_file_types = ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "application/vnd.ms-excel"];
    if (accepted_file_types.includes(type)) {
        ...
        $('#error').text('Sai định dạng mẫu, yêu cầu file theo mẫu. Nếu file lỗi vui lòng tải lại mẫu và điền lại.');
    }
    $('#preload').addClass('hidden');
}
